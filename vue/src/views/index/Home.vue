<template>
  <div class="home">
    ...
    <div class="main">
      <div class="left">
        <Menu @select="select" :isCollapse="isCollapse" :defaultActive="menuDefaultActive" />
      </div>
      <div class="right" :style="{ width: `calc(100% - ${isCollapse ? 0 : 200}px)` }">
        <div class="top">
          <div class="breadcrumb">
            <Breadcrumb :breadcrumbs="breadcrumbs" :isCollapse="isCollapse" @svg-click="svgClick" />
          </div>
          <div class="tabs">
            <Tabs :tabsActive="menuTabsActive" :menuTabs="menuTabs" @remove-tab="removeTab" />
          </div>
        </div>
        <div class="content">
